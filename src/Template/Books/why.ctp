...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      var book1 = <?php echo json_encode($book1); ?>;
      var book2 = <?php echo json_encode($book2); ?>;
      ...
      function drawChart() {
        ...
        var options = {
          hAxis: {title: book1,minValue: 0, maxValue: 5,gridlines:{count:6}},
          vAxis: {title: book2,minValue: 0, maxValue:5,gridlines:{count:6}},
